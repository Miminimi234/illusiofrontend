        ...
        {!showZodiac ? (
          ...
          <div className="space-y-8">
            ...
            <button
              ...
              className={`px-8 py-4 bg-transparent border-2 border-white/60 rounded-lg text-white text-lg hover:border-white/80 hover:bg-white/10 transition-all duration-300 focus:outline-none focus:border-white/80 ${
                showZodiacVideo ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
              }`}
              style={{ fontFamily: 'VT323, monospace' }}
            >
