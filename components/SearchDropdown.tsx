    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 pr-12 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400/50 transition-all duration-200"
        />
