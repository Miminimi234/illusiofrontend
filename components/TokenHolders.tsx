    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center text-white/60">
          ...
          <div className="text-sm text-white/40 mt-2">Loading token data...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-full flex items-center justify-center text-white/40">
        <div className="text-center">
          ...
          <div className="text-sm">Fetching holders for: <span className="text-blue-300 font-mono">{tokenData?.mint || 'token'}</span></div>
        </div>
      </div>
    );
  }
